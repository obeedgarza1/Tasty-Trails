...
def app():
    ...
    st.divider()
    menu_types, item_category, cities = load_sample_data(local_file_path, selected_columns)
    ...
    df_spark = load_data(local_file_path, selected_columns, selected_menu, selected_city, selected_category)
